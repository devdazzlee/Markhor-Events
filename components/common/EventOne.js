...
const EventOne = ({ tagline, title, buttonText, points, videoURL }) => {
  return (
    <section className="event-one event-three">
      <div className="container">
        ...
        <div className="event-one__inner wow fadeInUp" data-wow-delay="300ms">
          ...
          <div className="event-one__video-box">
            <video src={videoURL} autoPlay muted loop playsInline alt="Event Image" />
          </div>
        </div>
      </div>
    </section>
